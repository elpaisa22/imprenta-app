/**
 * application-domain [23/05/2015 11:01:36]
 */
...
public class Banco implements Persistible<String>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "IDBANCO")
	@NotNull(message = "{org.ambar.appl.be.Banco.id.NotNull}")
	public String getId() {
		return this.id;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Banco)) {
			return false;
		}

		Banco other = (Banco) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
