/**
 * application-domain [6/11/2014 16:13:37]
 */
...
/**
 * <p>
 * Entidad que representa a una Cobranza.
 * </p>
 *
 * @author Sebastian
 *
 */
@Entity
@Table(name = "AP_COBRANZA")
public class Cobranza implements Persistible<Long>, Trackingable, Versionable {
	...
	private List<DetalleCobranza> coleccionDetalleCobranza;
	...
	public Cobranza() {
		...
		this.coleccionDetalleCobranza = new ArrayList<DetalleCobranza>();
	}
	 ...
	 */
	public void setColeccionDetalleCobranza(List<DetalleCobranza> pColeccionDetalleCobranza) {
		coleccionDetalleCobranza = pColeccionDetalleCobranza;
	}

	/**
	 * Agrega una DetalleCobranza.
	 * @param pElement DetalleCobranza a agregar
	 */
	public void agregarDetalleCobranza(final DetalleCobranza pElement) {
		pElement.setCobranza(this);
		this.coleccionDetalleCobranza.add(pElement);
	}

	/**
	 * Remueve una DetalleCobranza.
	 * @param pElement DetalleCobranza a remover
	 */
	public void removerDetalleCobranza(final DetalleCobranza pElement) {
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Cobranza)) {
			return false;
		}
		Cobranza other = (Cobranza) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
