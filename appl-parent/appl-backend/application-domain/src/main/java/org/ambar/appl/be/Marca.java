/**
 * application-domain [21/05/2015 17:18:35]
 */
...
public class Marca implements Persistible<String>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "CODIGO")
	@NotNull(message = "{org.ambar.appl.be.Marca.id.NotNull}")
	public String getId() {
		return this.id;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Marca)) {
			return false;
		}

		Marca other = (Marca) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
