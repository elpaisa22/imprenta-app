/**
 * application-domain [8/6/2015 17:59:06]
 */
...
/**
 * <p>
 * Entidad que representa una Tipo de Ingreso.
 * </p>
 *
 * @author Sebastian
 *
 */
@Entity
@Table(name = "AP_TIPOINGRESO")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TipoIngreso implements Persistible<String>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "CODIGO")
	@NotNull(message = "{org.ambar.appl.be.TipoIngreso.id.NotNull}")
	public String getId() {
		return this.id;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof TipoIngreso)) {
			return false;
		}

		TipoIngreso other = (TipoIngreso) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
