/**
 * application-domain [21/05/2015 17:19:07]
 */
...
/**
 * <p>
 * Entidad que representa una Rubro.
 * </p>
 *
 * @author Sebastian
 */
...
public class Rubro implements Persistible<String>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "CODIGO")
	@NotNull(message = "{org.ambar.appl.be.Rubro.id.NotNull}")
	public String getId() {
		return this.id;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Rubro)) {
			return false;
		}

		Rubro other = (Rubro) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
