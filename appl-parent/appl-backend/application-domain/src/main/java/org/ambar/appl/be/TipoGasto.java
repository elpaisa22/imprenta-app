/**
 * application-domain [21/05/2015 17:19:30]
 */
...
/**
 * <p>
 * Entidad que representa una Tipo de Gasto.
 * </p>
 *
 * @author Sebastian
 */
@Entity
@Table(name = "AP_TIPOGASTO")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class TipoGasto implements Persistible<String>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "CODIGO")
	@NotNull(message = "{org.ambar.appl.be.TipoGasto.id.NotNull}")
	public String getId() {
		return this.id;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof TipoGasto)) {
			return false;
		}

		TipoGasto other = (TipoGasto) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
