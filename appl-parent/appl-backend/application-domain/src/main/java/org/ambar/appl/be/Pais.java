/**
 * application-domain [23/05/2015 11:25:40]
 */
...
public class Pais implements Persistible<String>, Trackingable, Versionable {
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Pais)) {
			return false;
		}

		Pais other = (Pais) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
