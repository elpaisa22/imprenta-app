/**
 * application-domain [23/05/2015 11:25:51]
 */
 ...
 */
@Entity
@Table(name = "AP_PROVINCIA")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class Provincia implements Persistible<ProvinciaID>, Trackingable, Versionable {
	...
	@Id
    @Column(name = "CODIGO")
	@NotNull(message = "{org.ambar.appl.be.Provincia.id.NotNull}")
	 ...
	 */
	@Override
	public void setId(ProvinciaID pId) {
		this.id = pId;
	}
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof Provincia)) {
			return false;
		}

		Provincia other = (Provincia) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
