/**
 * application-dto [8/6/2015 18:15:01]
 */
 ...
 * entidad {@link org.ambar.appl.be.TipoIngreso}.
 * </p>
 *
 * @author Sebastian
 *
 */
public class TipoIngresoDTO implements DTO<String>, TrackingableDTO, VersionableDTO {

	private static final long serialVersionUID = 7440529148538781854L;
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof TipoIngresoDTO)) {
			return false;
		}
		TipoIngresoDTO other = (TipoIngresoDTO) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
	...
	public String toString() {
		...
		builder.append("TipoIngresoDTO [id=");
