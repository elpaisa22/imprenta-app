/**
 * application-dto [23/05/2015 11:32:25]
 */
 ...
 * entidad {@link org.ambar.appl.be.Banco}.
 * </p>
 *
 * @author Sebastian
 *
 */
public class BancoDTO implements DTO<String>, TrackingableDTO, VersionableDTO {

	private static final long serialVersionUID = 8781184051800705830L;
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof BancoDTO)) {
			return false;
		}
		BancoDTO other = (BancoDTO) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
