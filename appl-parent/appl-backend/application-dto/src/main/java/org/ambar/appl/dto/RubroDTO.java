/**
 * application-dto [21/05/2015 17:27:32]
 */
 ...
 * entidad {@link org.ambar.appl.be.Rubro}.
 * </p>
 *
 * @author Sebastian
 *
 */
public class RubroDTO implements DTO<String>, TrackingableDTO, VersionableDTO {

	private static final long serialVersionUID = -8777748786692611634L;
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof RubroDTO)) {
			return false;
		}
		RubroDTO other = (RubroDTO) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
