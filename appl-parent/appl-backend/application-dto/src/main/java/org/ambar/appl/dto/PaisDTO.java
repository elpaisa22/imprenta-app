/**
 * application-dto [23/05/2015 11:32:15]
 */
 ...
 * entidad {@link org.ambar.appl.be.Pais}.
 * </p>
 *
 * @author Sebastian
 *
 */
public class PaisDTO implements DTO<String>, TrackingableDTO, VersionableDTO {

	private static final long serialVersionUID = -3794412930537660848L;
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof PaisDTO)) {
			return false;
		}
		PaisDTO other = (PaisDTO) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
