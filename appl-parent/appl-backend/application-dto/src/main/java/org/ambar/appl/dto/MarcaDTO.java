/**
 * application-dto [21/05/2015 17:27:24]
 */
 ...
 * entidad {@link org.ambar.appl.be.Marca}.
 * </p>
 *
 * @author Sebastian
 *
 */
public class MarcaDTO implements DTO<String>, TrackingableDTO, VersionableDTO {

	private static final long serialVersionUID = -2992916258341327530L;
	...
	public boolean equals(Object pObj) {
		...
		if (!(pObj instanceof MarcaDTO)) {
			return false;
		}
		MarcaDTO other = (MarcaDTO) pObj;
		if (this.id == null) {
			if (other.id != null) {
				return false;
			}
